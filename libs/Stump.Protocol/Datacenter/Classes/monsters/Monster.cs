...
namespace Stump.DofusProtocol.D2oClasses
{
	...
	public class Monster : IDataObject, IIndexedData
	{
		...
		public List<WorldEditor.D2OClasses.AnimFunMonsterData> animFunList;
		...
		public List<MonsterDrop> TemporisDrops
		{
			get { return this.temporisDrops; }
			set { this.temporisDrops = value; }
		}
		[D2OIgnore]
		public List<uint> Subareas
		{
		...
		public Boolean CanBeCarried
		{
			get { return this.canBeCarried; }
			set { this.canBeCarried = value; }
		}
		[D2OIgnore]
		public Boolean CanUsePortal
		{
			get { return this.canUsePortal; }
			set { this.canUsePortal = value; }
		}
		[D2OIgnore]
		public Boolean CanSwitchPos
		{
		...
		public Boolean UseRaceValues
		{
			get { return this.useRaceValues; }
			set { this.useRaceValues = value; }
		}
		[D2OIgnore]
		public int AggressiveZoneSize
		{
